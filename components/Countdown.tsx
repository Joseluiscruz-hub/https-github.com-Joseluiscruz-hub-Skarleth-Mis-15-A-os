  ...
  const TimeUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center mx-2 md:mx-4">
      <div className="w-16 h-16 md:w-24 md:h-24 bg-white/60 backdrop-blur-sm border border-xv-rose-gold/30 rounded-full flex items-center justify-center relative overflow-hidden group shadow-lg">
        ...
        <span className="font-cinzel text-2xl md:text-4xl text-xv-wine font-bold relative z-10">
    ...
    <section className="py-16 bg-gradient-to-r from-xv-bg via-white to-xv-bg relative">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          <h3 className="font-vibes text-5xl text-xv-rose-gold mb-2 drop-shadow-sm">Faltan</h3>
          <div className="w-16 h-0.5 bg-xv-rose mx-auto mb-2"></div>
          <p className="font-cinzel text-xv-wine text-sm tracking-widest">PARA EL GRAN DÍA</p>
        </div>
        
        <div className="flex flex-wrap justify-center items-center">
          <TimeUnit value={timeLeft.days} label="Días" />
          <span className="text-2xl text-xv-rose-gold mb-8 hidden md:block font-vibes">:</span>
