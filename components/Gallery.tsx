...
// use the base URL generated by Vite so we don’t hard‑code the repo name
// in two places and the paths automatically include the right prefix when
...
const photos = [
  ...
  // Objeto vacío eliminado aquí
  // added previously missing photos
  { src: base + '', caption: 'Recuerdo 18' },
  {
