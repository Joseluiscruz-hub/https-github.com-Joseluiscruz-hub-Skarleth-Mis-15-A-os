      ...
      <div className="container mx-auto px-4 relative z-10 max-w-2xl">
        <div className="bg-white/80 backdrop-blur-xl border border-white shadow-[0_10px_40px_rgba(225,173,186,0.2)] rounded-3xl p-8 md:p-12 relative">
          ...
          <div className="text-center mb-10 mt-4">
            <h2 className="titulos-cursiva text-5xl md:text-6xl text-xv-rose-dark mb-4">Confirmación</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block texto-general text-xv-wine text-xs mb-3 ml-1 tracking-wider">¿Podrás asistir?</label>
            ...
            <div>
              <label className="block texto-general text-xv-wine text-xs mb-2 ml-1 tracking-wider">Nombre Completo *</label>
              <input 
                type="text" 
                value={name}
            ...
            <div>
              <label className="block texto-general text-xv-wine text-xs mb-2 ml-1 tracking-wider">Apellidos de la Familia</label>
              <input 
                type="text" 
                value={family}
            ...
            {attendance === 'yes' && (
              <>
                <div>
                  <label className="block texto-general text-xv-wine text-xs mb-2 ml-1 tracking-wider">Nº de Asistentes</label>
                  <select 
                    value={guests}
            ...
            <div>
              <label className="block texto-general text-xv-wine text-xs mb-2 ml-1 tracking-wider">Mensaje para Skarleth (opcional)</label>
              <textarea 
                value={message}
