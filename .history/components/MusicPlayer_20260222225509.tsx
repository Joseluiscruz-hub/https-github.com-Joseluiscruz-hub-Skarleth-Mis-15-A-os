...
const songs = [
  {
    name: 'Canción 1',
    // Using the direct links provided by the user. Ensure the host allows
    // cross-origin requests, otherwise you may need to download the files
    // into your `public` folder and reference them with a relative path.
