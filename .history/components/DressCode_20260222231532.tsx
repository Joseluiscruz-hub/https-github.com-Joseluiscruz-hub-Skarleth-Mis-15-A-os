    ...
    <section className="py-16 bg-gradient-to-b from-white to-xv-bg relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="titulos-cursiva text-5xl text-xv-rose-gold mb-2">Código de Vestimenta</h2>
          <p className="texto-general text-xv-wine text-lg tracking-widest uppercase">Formal / Elegante</p>
        </motion.div>
